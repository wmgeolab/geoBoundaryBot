...
outPath = os.path.abspath("tmp/CGAZ/") + "/"
gBPath = os.path.abspath("../geoBoundaries/releaseData/gbOpen/") + "/"

stdGeom = os.path.abspath("./dta/usDoSLSIB_Mar2020.geojson")
stdISO = os.path.abspath("./dta/iso_3166_1_alpha_3.csv")

# Ignore warnings about using '()' in str.contains
warnings.filterwarnings("ignore", "This pattern has match groups")

# Ensure log directory exists
log_dir = "/sciclone/geograd/geoBoundaries/logs/cgaz"
os.makedirs(log_dir, exist_ok=True)
log_file = os.path.join(log_dir, "cgaz_builder.log")
...
def argparse_log(args):
    """Configure logging based on verbosity and return logger."""
    ...
    log = logging.getLogger()
    log.debug(f"Logger initialized with verbosity {args.verbose}")
    return log
