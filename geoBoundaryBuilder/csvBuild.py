...
#RUNS AFTER GITHUB PUSH OF AN UPDATE.
#NEEDS THE CORRECT HASH.
...
#Define Paths
gbOpenCSV = TMP_DIR + "/releaseData/geoBoundariesOpen-meta.csv"
gbHumCSV = TMP_DIR + "/releaseData/UNOCHA-meta.csv"
gbAuthCSV = TMP_DIR + "/releaseData/UNSALB-meta.csv"
