...
def citationUse(releaseType):
    ...
    citUse = "Disclaimer"
    citUse = "====================================================\n"
    citUse = "With respect to the works on or made available\n"
    citUse = "through download from www.geoboundaries.org,\n"
    citUse = "we make no representations or warranties—express, implied, or statutory—as\n"
    citUse = "to the validity, accuracy, completeness, or fitness for a particular purpose;\n" 
    citUse = "nor represent that use of such works would not infringe privately owned rights;\n"
    citUse = "nor assume any liability resulting from use of such works; and shall in no way\n"
    citUse = "be liable for any costs, expenses, claims, or demands arising out of use of such works."
    citUse = "====================================================\n"
    citUse = citUse + " \n"
    citUse = citUse + " \n"
